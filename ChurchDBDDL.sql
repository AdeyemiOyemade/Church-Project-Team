 ...
 *
 * Date Created : Monday, August 26, 2019 13:26:50
...
CREATE TABLE MEMBER(
    ...
    PARENT_MEMBER_ID             numeric(10, 0)    NULL,
...
ALTER TABLE MEMBER ADD CONSTRAINT FK_LOC_MEM 
    FOREIGN KEY (LOCATION_ID)
    REFERENCES LOCATION(LOCATION_ID)
go

ALTER TABLE MEMBER ADD CONSTRAINT FK_MEM_MEM 
...
ALTER TABLE MEMBER_ADDRESS ADD CONSTRAINT FK_MEM_MA 
    FOREIGN KEY (MEMBER_ID)
    REFERENCES MEMBER(MEMBER_ID)
go

ALTER TABLE MEMBER_ADDRESS ADD CONSTRAINT FK_SA_MA 
    FOREIGN KEY (ADDRESS_ID)
    REFERENCES STANDARD_ADDRESS(ADDRESS_ID)
go

ALTER TABLE MEMBER_ADDRESS ADD CONSTRAINT FK_SAT_MA 
...
ALTER TABLE MEMBER_CONTRIBUTION ADD CONSTRAINT FK_MEM_MC 
    FOREIGN KEY (MEMBER_ID)
    REFERENCES MEMBER(MEMBER_ID)
go

ALTER TABLE MEMBER_CONTRIBUTION ADD CONSTRAINT FK_SC_MC 
...
ALTER TABLE MEMBER_EMAIL ADD CONSTRAINT FK_EMAIL_ME 
    FOREIGN KEY (EMAIL_ID)
    REFERENCES EMAIL(EMAIL_ID)
go

ALTER TABLE MEMBER_EMAIL ADD CONSTRAINT FK_MEM_ME 
    FOREIGN KEY (MEMBER_ID)
    REFERENCES MEMBER(MEMBER_ID)
go
...
ALTER TABLE MEMBER_GROUP ADD CONSTRAINT FK_MEM_MG 
    FOREIGN KEY (MEMBER_ID)
    REFERENCES MEMBER(MEMBER_ID)
go

ALTER TABLE MEMBER_GROUP ADD CONSTRAINT FK_SG_MG 
...
ALTER TABLE MEMBER_MINISTRY ADD CONSTRAINT FK_MEM_MM 
    FOREIGN KEY (MEMBER_ID)
    REFERENCES MEMBER(MEMBER_ID)
go

ALTER TABLE MEMBER_MINISTRY ADD CONSTRAINT FK_SM_MM 
...
ALTER TABLE MEMBER_NAME ADD CONSTRAINT FK_MEM_MN 
    FOREIGN KEY (MEMBER_ID)
    REFERENCES MEMBER(MEMBER_ID)
go

ALTER TABLE MEMBER_NAME ADD CONSTRAINT FK_NM_MN 
    FOREIGN KEY (NAME_ID)
...
ALTER TABLE MEMBER_PHONE ADD CONSTRAINT FK_MEM_MP 
    FOREIGN KEY (MEMBER_ID)
    REFERENCES MEMBER(MEMBER_ID)
go

ALTER TABLE MEMBER_PHONE ADD CONSTRAINT FK_PH_MP 
...
ALTER TABLE MEMBERSHIP ADD CONSTRAINT FK_MEM_MEMBSHIP 
    FOREIGN KEY (MEMBER_ID)
    REFERENCES MEMBER(MEMBER_ID)
go

ALTER TABLE MEMBERSHIP ADD CONSTRAINT FK_MT_MEM 
...
ALTER TABLE PASTOR_ASSIGNMENT ADD CONSTRAINT FK_LOC_PA 
    FOREIGN KEY (LOCATION_ID)
    REFERENCES LOCATION(LOCATION_ID)
go

ALTER TABLE PASTOR_ASSIGNMENT ADD CONSTRAINT FK_MEM_PA 
